...
- **Lõi sinh đề (bám sát tài liệu):** mọi tài liệu **chuẩn hóa về PDF** rồi cho Gemini đọc bằng **vision** (giữ gạch
  ...
  — mặc định = trần từng model, tránh cắt dở vì thinking tokens tính vào trần). **Retry:** CTS **300s/lượt**, tối đa 3 lượt;
  ...
  (prompt/thoughts/output tokens). Prompt Extract (giữ nguyên văn + số thứ tự + đáp án đã đánh dấu) / Generate (sinh mới theo chủ đề).
