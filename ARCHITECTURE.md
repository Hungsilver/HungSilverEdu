...
- **`layout/shell.ts`** — `nz-layout` sider (menu Sản phẩm + Quản lý người dùng nếu Admin) + header avatar + dropdown Đăng xuất.
...
### 15.7 Giai đoạn 2 (schema sẵn, chưa code)
Học phí · Kho tài liệu (dùng upload có sẵn) · gửi Thông báo thật (Email/Zalo/Messenger) · Đánh giá tháng & xếp hạng · Cảnh báo tự động · Báo cáo phụ huynh theo tháng · Portal học sinh (role User).
