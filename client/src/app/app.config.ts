...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideNzIcons([
      ...
      FileDoneOutline, FileImageOutline, FilePdfOutline, FileTextOutline, FileWordOutline,
      SolutionOutline, IdcardOutline, AuditOutline, BarChartOutline,
      ...
      EyeInvisibleOutline, EyeOutline, AppstoreOutline, SettingOutline, MenuOutline, ArrowLeftOutline,
      ...
      InboxOutline, InsertRowRightOutline, ZoomInOutline, ZoomOutOutline, UserDeleteOutline,
      ...
      // Kho tài liệu + Đề & Bài tập (redesign):
      PaperClipOutline, ThunderboltOutline,
